...
namespace ASPNET_Assignment.Controllers
{
    public class HomeController : Controller
    {
        public ActionResult Index(string id)
        {
            ...
            {
                return Content("<h1>This is a plain demo of ContentResult </ h1 > ", "text / plain");
            }
            else if (id.ToLower() == "html")
            {
                return Content("<h1>This is a html demo of ContentResult </ h1 > ", "text / html");
            }
            else if (id.ToLower() == "xml")
            {
                return Content("<h1>This is a xml demo of ContentResult </ h1 > ", "text / xml");
            }
        ...
        {
            if (!System.IO.File.Exists(@"d:\Aradhya.JPG"))
            {
                return Content("File to be downloaded not found");
            }
            return File(@"d:\Aradhya.JPG", "image/jpg",
           "default.jpg");
        }
